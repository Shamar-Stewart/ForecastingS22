...
author:
- name: This is Me!
  affiliation: AAEC Department, Virginia Tech
...
# 3-5 words related to topic. Helps with Google searches, for .e.g    
...
The Wealth of Nations was published March 9, 1776, [see @R-base, for further details] during the Scottish Enlightenment and the Scottish Agricultural Revolution[e.g. @R-papaja]. It influenced several authors and economists, such as Karl Marx, as well as governments and organizations, setting the terms for economic debate and discussion for the next century and a half [@R-base; @R-papaja]. For example, Alexander Hamilton was influenced in part by The Wealth of Nations to write his Report on Manufactures, in which he argued against many of Smith's policies. Hamilton based much of this report on the ideas of Jean-Baptiste Colbert, and it was, in part, Colbert's ideas that Smith responded to, and criticized, with The Wealth of Nations.^[This is a easy way to add a footnote to this sentence.] 
...
**Discuss your data and the relevant data sources here.**^[Be sure to indicate your sample period and the frequency of the data.]
